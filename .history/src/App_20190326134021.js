...
//function that handles first name change, takes in the event
  ...
  handleLastNameChange = event => {
    //setState- changes the components state and tells React that this component and it's children need to be re-rendered with the updated state used primarly with event handlers and server responses
